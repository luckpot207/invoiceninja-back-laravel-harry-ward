...
use App\Http\Controllers\ShingleTypeController;
use App\Http\Controllers\ShingleTypeColorController;
use App\Http\Controllers\UnderlaymentController;
...
Route::group(['middleware' => ['throttle:api', 'api_db', 'token_auth', 'locale'], 'prefix' => 'api/v1', 'as' => 'api.'], function () {
    ...
    Route::resource('shingles', ShingleTypeController::class); // name = (shingles. index / create / show / update / destroy / edit
    Route::resource('shingle_colors', ShingleTypeColorController::class); // name = (shingles. index / create / show / update / destroy / edit
    Route::resource('underlayments', UnderlaymentController::class); // name = (shingles. index / create / show / update / destroy / edit
