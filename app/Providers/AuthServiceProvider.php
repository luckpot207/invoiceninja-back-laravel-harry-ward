...
use App\Policies\ShingleTypePolicy;
use App\Policies\ShingleTypeColorPolicy;
use App\Policies\UnderlaymentPolicy;
...
class AuthServiceProvider extends ServiceProvider
{
    ...
    protected $policies = [
        ...
        ShingleType::class => ShingleTypePolicy::class,
        ShingleTypeColor::class => ShingleTypeColorPolicy::class,
        Underlayment::class => UnderlaymentPolicy::class,
    ];
